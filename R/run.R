...
# -----------------------------------------------------------------------------
#' Run the explicit environmental SEEIR model
#'
#' @details All durations are in days.
#'
#' @param population Population vector (for each age group). Default = NULL,
...
#' population = pop$n, dt = 1,
#' contact_matrix_set=contact_matrices[[1]],
#' env_dat=dummy.env, env_slp=1)
#' # Note: this model would fit poorly because the environment is both random and defined as important!
#' }
